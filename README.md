...
3. Run the `start_project.py` script to create necessary files, then delete the script file as it is no longer needed.
4. Edit the `requirements.txt` file to match the dependencies you need for your project.
5. Delete the `/pages` folder if you are only building a single page app.
